...
#define TILE_DOOR_CLOSED_TOP 13u
#define TILE_DOOR_CLOSED_BOTTOM 14u
#define TILE_DOOR_OPEN_TOP 15u
#define TILE_DOOR_OPEN_BOTTOM 16u
#define TILE_DOOR TILE_DOOR_CLOSED_BOTTOM
#define TILE_WORLD_COUNT 17u

#define TILE_UI_CURSOR 17u
#define TILE_UI_PANEL 18u
#define TILE_UI_ARROW 19u
#define TILE_UI_LOCK 20u
#define TILE_DIGIT_0 21u
#define TILE_DIGIT_9 30u
#define TILE_UI_PICKAXE 31u
#define TILE_UI_PICKAXE_PLUS 32u
#define TILE_UI_HEART 33u

#define TILE_NORMAL_COUNT 34u
...
#define DROP_SPRITE_TILE_BASE (ENEMY_SPRITE_TILE_BASE + ENEMY_SPRITE_TILE_COUNT)
